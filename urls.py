...
from . import views
from .views import (BusinessLogic,JobListView,  Course, CourseStatus, 
    HomeView,JobDetailsView,
    ApplyJobView,SearchView
)
...
# business logic route
    path('duties/', BusinessLogic, name='duties'),
    # path('asset/', AssetManagement, name='asset'),
    path('course/', Course, name='course_taken'),
    path('status/', CourseStatus, name='status'),
